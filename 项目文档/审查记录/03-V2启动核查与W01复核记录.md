...
- 依据：`项目文档/设计方案/03-审计修复决策与逐项执行方案-V2.md` 第 0、11、15 节，以及原审计 `项目文档/审查记录/02-N00-N13实现后独立代码审计.md`。
...
| 检查面 | 证据与含义 |
|---|---|
| 设计契约 | `项目文档/设计方案/01-知识运行时设计方案-修订版2.1.md:448–449,560–582,745–773`：GLOBAL 禁填 workspace；WORKSPACE 要求已配置的单值并与目录匹配；Task 可信上下文限定读取资格。 |
