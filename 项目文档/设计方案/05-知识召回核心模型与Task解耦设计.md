...
> 2026-09-09 当前状态：2.2及“项目名称/别名/业务语义自动识别＋明确预授权项目由Hook交付能力”已安装，用户确认本轮验收成功、无阻碍。真实检查与范围裁定见[验收记录](../验证记录/04-设计2.2实现与人工切换.md#2026-09-09-人工验收与用户确认)。§21覆盖此前仅依赖cwd的新项目签发路线和较窄的Recall触发条件；以下2026-09-08的“本轮/尚未实施”保留为当时文档修订边界。
